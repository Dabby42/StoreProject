...
# 'BASH_SOURCE[0]' gives the file path e.g. './admin/start_disposable.sh'
# 'dirname' then extracts the directory of the file e.g. './admin'
# 'cd' changes the directory to that of 'admin' e.g. 'cd ./admin'
# 'pwd' extracts the path of the current working directory e.g. '/Users/admin/product/admin'
SCRIPT_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )"

# 'dirname' then extracts the directory of the project e.g. '/Users/admin/product/'
